...
function invoicedetails(invoice){
	...
	switch(invoice){
		case "12months":
			document.getElementById("invoice").innerHTML = document.getElementById("product1").innerHTML;
			break;

		case "06months":
			document.getElementById("invoice").innerHTML = document.getElementById("product2").innerHTML;
			break;
			
		case "03months":
			document.getElementById("invoice").innerHTML = document.getElementById("product3").innerHTML;
			break;
...
function invoicedetails(invoice2){
	alert(invoice2);
